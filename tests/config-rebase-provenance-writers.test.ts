...
const writerContracts: Record<string, string[]> = {
  ...
  "src/server/management/config-routes.ts": [
    ...
    "codexAccountPickerEnabled", "oauthOpenBrowser", "autoReviewModel", "autoCompactModel",
    "helperTurnScope", "helperTurnReasoningEffort", "helperTurnCodexRemainingPercentThreshold",
  ],
