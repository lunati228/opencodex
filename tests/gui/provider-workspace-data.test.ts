...
describe("provider-icons", () => {
  ...
  test("managed NVIDIA bundle ids use consistent model-aware labels", () => {
    expect(formatProviderDisplayName("nvidia-glm-5.2")).toBe("NVIDIA | GLM 5.2");
    expect(formatProviderDisplayName("nvidia-deepseek-v4-pro"))
