...
export const MANAGEMENT_ROUTES: readonly ManagementRoute[] = [
  ...
  // server/management/agy-usage-routes
  { method: "GET", path: "/api/agy-usage/status", module: "server/management/agy-usage-routes", mutates: false },
  { method: "POST", path: "/api/agy-usage/refresh", module: "server/management/agy-usage-routes", mutates: true },
  ...
  { method: "GET", path: "/api/external-bundles", module: "server/management/config-routes", mutates: false },
  { method: "GET", path: "/api/helper-turn-models", module: "server/management/config-routes", mutates: false },
  ...
  { method: "PUT", path: "/api/external-bundles", module: "server/management/config-routes", mutates: true },
  { method: "PUT", path: "/api/helper-turn-models", module: "server/management/config-routes", mutates: true },
  ...
  // server/management/local-runtime-routes
  { method: "GET", path: "/api/local-runtime/status", module: "server/management/local-runtime-routes", mutates: false },
  { method: "POST", path: "/api/local-runtime/apply", module: "server/management/local-runtime-routes", mutates: true },
  { method: "POST", path: "/api/local-runtime/enable", module: "server/management/local-runtime-routes", mutates: true },
  { method: "POST", path: "/api/local-runtime/start", module: "server/management/local-runtime-routes", mutates: true },
  { method: "POST", path: "/api/local-runtime/stop", module: "server/management/local-runtime-routes", mutates: true },
  { method: "PUT", path: "/api/local-runtime/autostart", module: "server/management/local-runtime-routes", mutates: true },
