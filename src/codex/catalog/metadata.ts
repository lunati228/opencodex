 ...
 *
 * The clamp remains an independent upstream contract even though this fork's 85.5% compaction
 * trigger currently fires before the ceiling for the known native and API-key windows.
 */
