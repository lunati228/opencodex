...
export const CLI_COMMANDS: CliCommandEntry[] = [
  ...
  },
  {
    ...
    usage: "ocx codex-companion <run|status> [--images codex.exe,...] [--keep-model-loaded] [--keep-proxy-running]",
    summary: "Run the proxy and local model only while Codex is running.",
    details: [
      "Starts the proxy when Codex appears, then releases the local model and companion-owned proxy after Codex closes.",
      "Use status with Codex open to confirm the watched image name and current ownership.",
    ],
  },
  {
    name: "tray",
  ...
  {
    name: "local-runtime",
    usage: "ocx local-runtime <status|start|stop|enable|context|autostart> ...",
    summary: "Inspect and control the managed local Qwen runtime.",
  },
  {
    name: "route",
