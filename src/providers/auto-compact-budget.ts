...
/**
 * Native Codex reserves 5% of the catalog window, then compacts at roughly 90%
 * of the remaining working window: 0.95 * 0.90 = 0.855.
 */
 ...
 * default native-parity 85.5% envelope.
 */
export function clampAutoCompactTokenLimit(
  ...
  const candidates = [autoCompactLimitFor(contextWindow), contextWindow];
