...
/** Companion-only opt-in: refuse the recycle unless no data-plane turn is active. */
export const SYSTEM_RESTART_REQUIRE_IDLE_HEADER = "x-opencodex-restart-require-idle";
