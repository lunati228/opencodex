...
import { CodexAccountPoolLoadStates, CodexAccountPoolMainCard, CodexAccountPoolPageHead, CodexAccountPoolActions } from "./codex-account-pool-main-card";
      ...
      */}
      ...
      {!(loadState === "loading" && accounts.length === 0) && (
        <>
          ...
          {/* The separate AGY/MCP account is intentionally explicit and on-demand:
              reading it starts an interactive Antigravity CLI session. */}
          <AntigravityQuotaCard apiBase={apiBase} title={t("agyUsage.titleMcp")} />
