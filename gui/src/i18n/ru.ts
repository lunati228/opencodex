...
"common.discard": "Отбросить",
 ...
 "logs.filter.conversation.clear": "Сбросить",
  ...
  "pws.managedProvider": "Управляемый провайдер",
  "pws.managedProviderHint": "Этот провайдер создаётся из защищённой локальной конфигурации. Здесь нельзя изменить его адрес, модель или учётные данные.",
  "pws.quotaRefresh": "Обновить использование",
  "pws.quotaRefreshing": "Обновление…",
  "pws.quotaRefreshFailed": "Не удалось обновить официальные данные квоты. Последние успешно полученные значения остаются видимыми.",
  "pws.quotaRefreshed": "Обновление завершено. Время провайдера ниже относится к последнему успешному получению данных.",
  "localRuntime.title": "Локальная среда модели",
  "localRuntime.description": "OpenCodex управляет только проверенным процессом llama-server, который запустил сам. Сторонний процесс на настроенном порту никогда не принимается под управление и не останавливается.",
  "localRuntime.refresh": "Обновить состояние",
  "localRuntime.status": "Состояние",
  "localRuntime.requested": "Запрошенный nCtx",
  "localRuntime.effective": "Действующий nCtx",
  "localRuntime.lastKnownGood": "Последний рабочий nCtx",
  "localRuntime.process": "ID управляемого процесса",
  "localRuntime.failure": "Сведения о среде: {reason}",
  "localRuntime.modelLabel": "Локальная модель",
  "localRuntime.modelHint": "Смена модели перезапускает среду.",
  "localRuntime.reasoningLabel": "Уровень рассуждений",
  "localRuntime.reasoningHint": "Задаёт бюджет токенов на рассуждения. Более высокие значения повышают качество на сложных задачах и увеличивают задержку ответа.",
  "localRuntime.reasoning.off": "Выкл.",
  "localRuntime.reasoning.low": "Низкий",
  "localRuntime.reasoning.medium": "Средний",
  "localRuntime.reasoning.high": "Высокий",
  "localRuntime.reasoning.xhigh": "Очень высокий",
  "agyUsage.titleMcp": "Antigravity MCP (AGY)",
  "agyUsage.refresh": "Обновить",
  "agyUsage.refreshHint": "Читает квоту из Antigravity CLI. Занимает 20–40 секунд.",
  "agyUsage.reading": "Чтение…",
  "agyUsage.never": "Данных пока нет. Нажмите «Обновить», чтобы получить квоту.",
  "agyUsage.stale": "Показано последнее успешное чтение; последнее обновление не удалось ({reason}).",
  "agyUsage.failed": "Не удалось прочитать квоту Antigravity: {reason}",
  "agyUsage.readFailed": "Запрос квоты Antigravity не выполнен.",
  "localRuntime.contextLabel": "Выделение контекста среды (nCtx)",
  "localRuntime.contextInputLabel": "Выделение контекста среды",
  "localRuntime.contextHint": "Допустимы значения {min}–{max} с шагом {step} токенов. Изменение вступает в силу только после успешного применения и перезапуска.",
  "localRuntime.contextChoicesHint": "Фиксированные варианты: {choices}. Изменение вступает в силу только после успешного применения и перезапуска.",
  "localRuntime.working": "Выполняется…",
  "localRuntime.applyRestart": "Применить и перезапустить",
  "localRuntime.resetDraft": "Сбросить",
  "localRuntime.stop": "Остановить управляемую среду",
  "localRuntime.start": "Запустить управляемую среду",
  "localRuntime.requestCapTitle": "Лимит контекста запроса провайдера",
  "localRuntime.requestCapHint": "Лимит контекста модели на запрос настраивается отдельно. Он ограничивает маршрутизируемые запросы и не должен превышать действующий nCtx, показанный выше.",
  "localRuntime.loadFailed": "Не удалось загрузить состояние локальной среды.",
  "localRuntime.statusStale": "Последнее состояние локальной среды остаётся видимым, но может быть устаревшим.",
  "localRuntime.staleRevision": "Среда была изменена другой операцией. Состояние обновлено; проверьте его перед повторным применением.",
  "localRuntime.actionFailed": "Операция локальной среды завершилась ошибкой.",
  "localRuntime.restartAccepted": "Запрошенный контекст принят. Выполняется проверка среды.",
  "localRuntime.actionAccepted": "Операция среды принята.",
  "localRuntime.state.starting": "Запуск и проверка",
  "localRuntime.state.running": "Работает и проверена",
  "localRuntime.state.restarting": "Перезапуск и проверка",
  "localRuntime.state.stopping": "Остановка",
  "localRuntime.state.rolledBack": "Возврат к последнему рабочему состоянию",
  "localRuntime.state.failed": "Ошибка",
  "localRuntime.state.foreignPort": "Заблокировано: порт занят другим процессом",
  "localRuntime.state.stopped": "Остановлена",
  "localRuntime.state.loading": "Загрузка…",
