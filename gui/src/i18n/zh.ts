...
"codexSet.dialog.notRendered": "在我们读取的那一轮中，此层没有发送任何内容。各部分仅在内容变化时才会重新发送，因此单次采样可能看不到它。",
  ...
  "pws.rateLimits": "速率限制",
  "pws.managedProvider": "托管提供商",
  "pws.managedProviderHint": "此提供商由受保护的本地配置生成。无法在此编辑其端点、模型或凭据。",
  "pws.quotaRefresh": "刷新用量",
  "pws.quotaRefreshing": "正在刷新…",
  "pws.quotaRefreshFailed": "无法刷新官方配额数据。仍会显示上次成功获取的值。",
  "pws.quotaRefreshed": "刷新已完成。下方提供商时间戳表示最近一次成功获取的数据。",
  "localRuntime.title": "本地模型运行时",
  "localRuntime.description": "OpenCodex 只控制由它启动并验证的 llama-server 进程。绝不会接管或停止占用配置端口的其他进程。",
  "localRuntime.refresh": "刷新状态",
  "localRuntime.status": "状态",
  "localRuntime.requested": "请求的 nCtx",
  "localRuntime.effective": "生效的 nCtx",
  "localRuntime.lastKnownGood": "上次正常的 nCtx",
  "localRuntime.process": "托管进程 ID",
  "localRuntime.failure": "运行时详情：{reason}",
  "localRuntime.modelLabel": "本地模型",
  "localRuntime.modelHint": "切换模型会重启运行时。",
  "localRuntime.reasoningLabel": "推理强度",
  "localRuntime.reasoningHint": "设置思考词元预算。设置得越高，困难任务的质量越好，响应延迟也越大。",
  "localRuntime.reasoning.off": "关闭",
  "localRuntime.reasoning.low": "低",
  "localRuntime.reasoning.medium": "中",
  "localRuntime.reasoning.high": "高",
  "localRuntime.reasoning.xhigh": "极高",
  "agyUsage.titleMcp": "Antigravity MCP (AGY)",
  "agyUsage.refresh": "刷新",
  "agyUsage.refreshHint": "从 Antigravity CLI 读取配额，需要 20-40 秒。",
  "agyUsage.reading": "读取中…",
  "agyUsage.never": "尚未读取。点击刷新获取配额。",
  "agyUsage.stale": "显示的是最近一次成功读取的结果；最新一次刷新失败（{reason}）。",
  "agyUsage.failed": "无法读取 Antigravity 配额：{reason}",
  "agyUsage.readFailed": "Antigravity 配额请求失败。",
  "localRuntime.contextLabel": "运行时上下文分配（nCtx）",
  "localRuntime.contextInputLabel": "运行时上下文分配",
  "localRuntime.contextHint": "允许值为 {min}–{max}，步长为 {step} 个词元。只有“应用并重启”成功后更改才会生效。",
  "localRuntime.contextChoicesHint": "固定选项：{choices}。只有“应用并重启”成功后更改才会生效。",
  "localRuntime.working": "正在处理…",
  "localRuntime.applyRestart": "应用并重启",
  "localRuntime.resetDraft": "重置",
  "localRuntime.stop": "停止托管运行时",
  "localRuntime.start": "启动托管运行时",
  "localRuntime.requestCapTitle": "提供商请求上下文上限",
  "localRuntime.requestCapHint": "每次请求的模型上下文上限需单独配置。它限制路由请求，且不得超过上方显示的生效 nCtx。",
  "localRuntime.loadFailed": "无法加载本地运行时状态。",
  "localRuntime.statusStale": "仍显示上次的本地运行时状态，但该状态可能已过期。",
  "localRuntime.staleRevision": "另一个操作已更改运行时。状态已刷新；请检查后再应用。",
  "localRuntime.actionFailed": "本地运行时操作失败。",
  "localRuntime.restartAccepted": "请求的上下文已接受。正在验证运行时。",
  "localRuntime.actionAccepted": "运行时操作已接受。",
  "localRuntime.state.starting": "正在启动并验证",
  "localRuntime.state.running": "正在运行且已验证",
  "localRuntime.state.restarting": "正在重启并验证",
  "localRuntime.state.stopping": "正在停止",
  "localRuntime.state.rolledBack": "已回滚至上次正常状态",
  "localRuntime.state.failed": "失败",
  "localRuntime.state.foreignPort": "已阻止：端口由其他进程占用",
  "localRuntime.state.stopped": "已停止",
  "localRuntime.state.loading": "正在加载…",
