...
"common.discard": "破棄",
 ...
 "logs.filter.conversation.clear": "クリア",
  ...
  "pws.managedProvider": "管理対象プロバイダー",
  "pws.managedProviderHint": "このプロバイダーは保護されたローカル設定から生成されます。エンドポイント、モデル、認証情報はここでは編集できません。",
  "pws.quotaRefresh": "使用量を更新",
  "pws.quotaRefreshing": "更新中…",
  "pws.quotaRefreshFailed": "公式クォータ情報を更新できませんでした。最後に正常取得した値はそのまま表示されます。",
  "pws.quotaRefreshed": "更新処理が完了しました。下のプロバイダー時刻は最後に成功した取得を示します。",
  "localRuntime.title": "ローカルモデルのランタイム",
  "localRuntime.description": "OpenCodex が制御するのは、自身が起動して検証した llama-server プロセスだけです。設定ポートを使用する別プロセスを引き継いだり停止したりすることはありません。",
  "localRuntime.refresh": "状態を更新",
  "localRuntime.status": "状態",
  "localRuntime.requested": "要求 nCtx",
  "localRuntime.effective": "有効な nCtx",
  "localRuntime.lastKnownGood": "直近正常時の nCtx",
  "localRuntime.process": "管理プロセス ID",
  "localRuntime.failure": "ランタイム詳細: {reason}",
  "localRuntime.modelLabel": "ローカルモデル",
  "localRuntime.modelHint": "モデルを切り替えるとランタイムが再起動します。",
  "localRuntime.reasoningLabel": "推論負荷",
  "localRuntime.reasoningHint": "思考トークンの予算を設定します。値を上げると難しいタスクでの品質が向上し、応答の遅延も増えます。",
  "localRuntime.reasoning.off": "オフ",
  "localRuntime.reasoning.low": "低",
  "localRuntime.reasoning.medium": "中",
  "localRuntime.reasoning.high": "高",
  "localRuntime.reasoning.xhigh": "超高",
  "agyUsage.titleMcp": "Antigravity MCP (AGY)",
  "agyUsage.refresh": "更新",
  "agyUsage.refreshHint": "Antigravity CLI からクォータを読み取ります。20〜40秒かかります。",
  "agyUsage.reading": "読み取り中…",
  "agyUsage.never": "まだ読み取っていません。更新でクォータを取得します。",
  "agyUsage.stale": "最後に成功した読み取りを表示しています。最新の更新は失敗しました（{reason}）。",
  "agyUsage.failed": "Antigravity のクォータを読み取れませんでした: {reason}",
  "agyUsage.readFailed": "Antigravity のクォータ取得に失敗しました。",
  "localRuntime.contextLabel": "ランタイムのコンテキスト割り当て (nCtx)",
  "localRuntime.contextInputLabel": "ランタイムのコンテキスト割り当て",
  "localRuntime.contextHint": "{min}～{max} の範囲を {step} トークン単位で指定できます。変更は「適用して再起動」が成功した後にのみ反映されます。",
  "localRuntime.contextCheckpoint": "{value}K",
  "localRuntime.contextChoicesHint": "固定選択肢: {choices}。変更は「適用して再起動」が成功した後にのみ反映されます。",
  "localRuntime.working": "処理中…",
  "localRuntime.applyRestart": "適用して再起動",
  "localRuntime.resetDraft": "リセット",
  "localRuntime.stop": "管理ランタイムを停止",
  "localRuntime.start": "管理ランタイムを開始",
  "localRuntime.requestCapTitle": "プロバイダー要求のコンテキスト上限",
  "localRuntime.requestCapHint": "要求ごとのモデルコンテキスト上限は別に設定します。ルーティングされる要求を制限し、上に表示された有効な nCtx を超えることはできません。",
  "localRuntime.loadFailed": "ローカルランタイムの状態を読み込めませんでした。",
  "localRuntime.statusStale": "最後のローカルランタイム状態を表示していますが、古い可能性があります。",
  "localRuntime.staleRevision": "別の操作によってランタイムが変更されました。状態を更新したので、再適用前に確認してください。",
  "localRuntime.actionFailed": "ローカルランタイム操作に失敗しました。",
  "localRuntime.restartAccepted": "要求したコンテキストを受け付けました。ランタイムを検証中です。",
  "localRuntime.actionAccepted": "ランタイム操作を受け付けました。",
  "localRuntime.state.starting": "起動および検証中",
  "localRuntime.state.running": "実行中・検証済み",
  "localRuntime.state.restarting": "再起動および検証中",
  "localRuntime.state.stopping": "停止中",
  "localRuntime.state.rolledBack": "直近の正常状態へロールバック済み",
  "localRuntime.state.failed": "失敗",
  "localRuntime.state.foreignPort": "ブロック: 別プロセスがポートを使用中",
  "localRuntime.state.stopped": "停止",
  "localRuntime.state.loading": "読み込み中…",
