...
"codexSet.dialog.notRendered": "확인한 턴에서는 이 레이어가 아무것도 보내지 않았습니다. 각 섹션은 내용이 바뀔 때만 다시 전송되므로, 한 번 확인한 것만으로는 빠져 보일 수 있습니다.",
 ...
 "quota.fiveHourLimit": "5시간 한도",
  ...
  "pws.managedProvider": "관리형 프로바이더",
  "pws.managedProviderHint": "이 프로바이더는 보호된 로컬 구성에서 생성됩니다. 여기서는 엔드포인트, 모델 및 자격 증명을 편집할 수 없습니다.",
  "pws.quotaRefresh": "사용량 새로 고침",
  "pws.quotaRefreshing": "새로 고치는 중…",
  "pws.quotaRefreshFailed": "공식 할당량 데이터를 새로 고칠 수 없습니다. 마지막으로 성공한 값은 계속 표시됩니다.",
  "pws.quotaRefreshed": "새로 고침이 완료되었습니다. 아래 제공자 타임스탬프는 마지막으로 성공한 샘플을 표시합니다.",
  "localRuntime.title": "로컬 모델 런타임",
  "localRuntime.description": "OpenCodex는 직접 시작하고 검증한 llama-server 프로세스만 제어합니다. 구성된 포트를 사용하는 다른 프로세스를 인계하거나 중지하지 않습니다.",
  "localRuntime.refresh": "상태 새로 고침",
  "localRuntime.status": "상태",
  "localRuntime.requested": "요청된 nCtx",
  "localRuntime.effective": "적용 중인 nCtx",
  "localRuntime.lastKnownGood": "마지막 정상 nCtx",
  "localRuntime.process": "관리 프로세스 ID",
  "localRuntime.failure": "런타임 세부 정보: {reason}",
  "localRuntime.modelLabel": "로컬 모델",
  "localRuntime.modelHint": "모델을 변경하면 런타임이 다시 시작됩니다.",
  "localRuntime.reasoningLabel": "추론 강도",
  "localRuntime.reasoningHint": "사고 토큰 예산을 설정합니다. 값이 높을수록 어려운 작업의 품질이 좋아지고 응답 지연이 늘어납니다.",
  "localRuntime.reasoning.off": "끔",
  "localRuntime.reasoning.low": "낮음",
  "localRuntime.reasoning.medium": "중간",
  "localRuntime.reasoning.high": "높음",
  "localRuntime.reasoning.xhigh": "매우 높음",
  "agyUsage.titleMcp": "Antigravity MCP (AGY)",
  "agyUsage.refresh": "새로 고침",
  "agyUsage.refreshHint": "Antigravity CLI에서 할당량을 읽습니다. 20~40초가 걸립니다.",
  "agyUsage.reading": "읽는 중…",
  "agyUsage.never": "아직 읽지 않았습니다. 새로 고침으로 할당량을 가져오세요.",
  "agyUsage.stale": "마지막으로 성공한 읽기를 표시합니다. 최근 새로 고침은 실패했습니다({reason}).",
  "agyUsage.failed": "Antigravity 할당량을 읽을 수 없습니다: {reason}",
  "agyUsage.readFailed": "Antigravity 할당량 요청이 실패했습니다.",
  "localRuntime.contextLabel": "런타임 컨텍스트 할당(nCtx)",
  "localRuntime.contextInputLabel": "런타임 컨텍스트 할당",
  "localRuntime.contextHint": "{min}–{max} 범위에서 {step} 토큰 단위로 선택할 수 있습니다. 적용 및 재시작이 성공한 뒤에만 변경됩니다.",
  "localRuntime.contextCheckpoint": "{value}K",
  "localRuntime.contextChoicesHint": "고정 선택값: {choices}. 적용 및 재시작이 성공한 뒤에만 변경됩니다.",
  "localRuntime.working": "작업 중…",
  "localRuntime.applyRestart": "적용 및 재시작",
  "localRuntime.resetDraft": "재설정",
  "localRuntime.stop": "관리형 런타임 중지",
  "localRuntime.start": "관리형 런타임 시작",
  "localRuntime.requestCapTitle": "프로바이더 요청 컨텍스트 상한",
  "localRuntime.requestCapHint": "요청별 모델 컨텍스트 상한은 별도로 구성됩니다. 라우팅된 요청을 제한하며 위에 표시된 적용 중인 nCtx를 초과할 수 없습니다.",
  "localRuntime.loadFailed": "로컬 런타임 상태를 불러올 수 없습니다.",
  "localRuntime.statusStale": "마지막 로컬 런타임 상태를 계속 표시하지만 최신 상태가 아닐 수 있습니다.",
  "localRuntime.staleRevision": "다른 작업에서 런타임이 변경되었습니다. 상태를 새로 고쳤으므로 다시 적용하기 전에 확인하세요.",
  "localRuntime.actionFailed": "로컬 런타임 작업에 실패했습니다.",
  "localRuntime.restartAccepted": "요청한 컨텍스트가 승인되었습니다. 런타임을 검증하는 중입니다.",
  "localRuntime.actionAccepted": "런타임 작업이 승인되었습니다.",
  "localRuntime.state.starting": "시작 및 검증 중",
  "localRuntime.state.running": "실행 및 검증됨",
  "localRuntime.state.restarting": "재시작 및 검증 중",
  "localRuntime.state.stopping": "중지 중",
  "localRuntime.state.rolledBack": "마지막 정상 상태로 롤백됨",
  "localRuntime.state.failed": "실패",
  "localRuntime.state.foreignPort": "차단됨: 다른 프로세스가 포트를 사용 중",
  "localRuntime.state.stopped": "중지됨",
  "localRuntime.state.loading": "불러오는 중…",
