...
"codexSet.dialog.notRendered": "In der gelesenen Runde hat diese Ebene nichts gesendet. Abschnitte werden nur bei Änderungen erneut gesendet, daher kann eine einzelne Stichprobe sie nicht enthalten.",
 ...
 "quota.fiveHourLimit": "5-Stunden-Limit",
  ...
  "pws.managedProvider": "Verwalteter Anbieter",
  "pws.managedProviderHint": "Dieser Anbieter wird aus einer geschützten lokalen Konfiguration erzeugt. Endpunkt, Modell und Zugangsdaten können hier nicht bearbeitet werden.",
  "pws.quotaRefresh": "Nutzung aktualisieren",
  "pws.quotaRefreshing": "Wird aktualisiert…",
  "pws.quotaRefreshFailed": "Offizielle Kontingentdaten konnten nicht aktualisiert werden. Die letzten erfolgreichen Werte bleiben sichtbar.",
  "pws.quotaRefreshed": "Aktualisierung abgeschlossen. Der Anbieter-Zeitstempel unten zeigt die letzte erfolgreiche Abfrage.",
  "localRuntime.title": "Lokale Modell-Laufzeit",
  "localRuntime.description": "OpenCodex steuert nur den verifizierten llama-server-Prozess, den es selbst gestartet hat. Ein fremder Listener am konfigurierten Port wird nie übernommen oder beendet.",
  "localRuntime.refresh": "Status aktualisieren",
  "localRuntime.status": "Status",
  "localRuntime.requested": "Angeforderter nCtx",
  "localRuntime.effective": "Wirksamer nCtx",
  "localRuntime.lastKnownGood": "Letzter funktionierender nCtx",
  "localRuntime.process": "Verwaltete Prozess-ID",
  "localRuntime.failure": "Laufzeitdetail: {reason}",
  "localRuntime.modelLabel": "Lokales Modell",
  "localRuntime.modelHint": "Ein Modellwechsel startet die Laufzeit neu.",
  "localRuntime.reasoningLabel": "Reasoning-Aufwand",
  "localRuntime.reasoningHint": "Legt das Budget für Denk-Token fest. Höhere Stufen verbessern die Qualität bei schwierigen Aufgaben und erhöhen die Antwortlatenz.",
  "localRuntime.reasoning.off": "Aus",
  "localRuntime.reasoning.low": "Niedrig",
  "localRuntime.reasoning.medium": "Mittel",
  "localRuntime.reasoning.high": "Hoch",
  "localRuntime.reasoning.xhigh": "Extra hoch",
  "agyUsage.titleMcp": "Antigravity MCP (AGY)",
  "agyUsage.refresh": "Aktualisieren",
  "agyUsage.refreshHint": "Liest das Kontingent aus der Antigravity-CLI. Dauert 20-40 Sekunden.",
  "agyUsage.reading": "Wird gelesen…",
  "agyUsage.never": "Noch keine Abfrage. Mit Aktualisieren das Kontingent abrufen.",
  "agyUsage.stale": "Es wird die letzte erfolgreiche Abfrage angezeigt; die neueste Aktualisierung ist fehlgeschlagen ({reason}).",
  "agyUsage.failed": "Antigravity-Kontingent konnte nicht gelesen werden: {reason}",
  "agyUsage.readFailed": "Die Antigravity-Kontingentabfrage ist fehlgeschlagen.",
  "localRuntime.contextLabel": "Laufzeit-Kontextzuweisung (nCtx)",
  "localRuntime.contextInputLabel": "Laufzeit-Kontextzuweisung",
  "localRuntime.contextHint": "Zulässig sind {min}–{max} in Schritten von {step} Token. Eine Änderung gilt erst nach erfolgreichem Anwenden und Neustarten.",
  "localRuntime.contextCheckpoint": "{value}K",
  "localRuntime.contextChoicesHint": "Feste Auswahlwerte: {choices}. Eine Änderung gilt erst nach erfolgreichem Anwenden und Neustarten.",
  "localRuntime.working": "Vorgang läuft…",
  "localRuntime.applyRestart": "Anwenden & neu starten",
  "localRuntime.resetDraft": "Zurücksetzen",
  "localRuntime.stop": "Verwaltete Laufzeit stoppen",
  "localRuntime.start": "Verwaltete Laufzeit starten",
  "localRuntime.requestCapTitle": "Kontextlimit pro Anbieteranfrage",
  "localRuntime.requestCapHint": "Das Modell-Kontextlimit pro Anfrage wird separat konfiguriert. Es begrenzt weitergeleitete Anfragen und darf den oben gezeigten wirksamen nCtx nicht überschreiten.",
  "localRuntime.loadFailed": "Der Status der lokalen Laufzeit konnte nicht geladen werden.",
  "localRuntime.statusStale": "Der letzte Status der lokalen Laufzeit bleibt sichtbar, könnte aber veraltet sein.",
  "localRuntime.staleRevision": "Die Laufzeit wurde durch einen anderen Vorgang geändert. Der Status wurde aktualisiert; vor erneutem Anwenden bitte prüfen.",
  "localRuntime.actionFailed": "Der Vorgang der lokalen Laufzeit ist fehlgeschlagen.",
  "localRuntime.restartAccepted": "Der angeforderte Kontext wurde akzeptiert. Die Laufzeitprüfung läuft.",
  "localRuntime.actionAccepted": "Der Laufzeitvorgang wurde akzeptiert.",
  "localRuntime.state.starting": "Start und Prüfung laufen",
  "localRuntime.state.running": "Läuft und ist geprüft",
  "localRuntime.state.restarting": "Neustart und Prüfung laufen",
  "localRuntime.state.stopping": "Wird gestoppt",
  "localRuntime.state.rolledBack": "Auf letzten funktionierenden Stand zurückgesetzt",
  "localRuntime.state.failed": "Fehlgeschlagen",
  "localRuntime.state.foreignPort": "Blockiert: Port gehört einem anderen Prozess",
  "localRuntime.state.stopped": "Gestoppt",
  "localRuntime.state.loading": "Wird geladen…",
