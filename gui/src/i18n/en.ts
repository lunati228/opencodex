...
"common.discard": "Discard",
  ...
  "pws.managedProvider": "Managed provider",
  "pws.managedProviderHint": "This provider is generated from a protected local configuration. Its endpoint, model, and credentials cannot be edited here.",
  "pws.quotaRefresh": "Refresh usage",
  "pws.quotaRefreshing": "Refreshing…",
  "pws.quotaRefreshFailed": "Could not refresh official quota data. The last successful values remain visible.",
  "pws.quotaRefreshed": "Refresh completed. The provider timestamp below shows the last successful sample.",
  "localRuntime.title": "Local model runtime",
  "localRuntime.description": "OpenCodex controls only the verified llama-server process it started. An unrelated listener on the configured port is never adopted or stopped.",
  "localRuntime.refresh": "Refresh status",
  "localRuntime.status": "State",
  "localRuntime.requested": "Requested nCtx",
  "localRuntime.effective": "Effective nCtx",
  "localRuntime.lastKnownGood": "Last-known-good nCtx",
  "localRuntime.process": "Managed process ID",
  "localRuntime.failure": "Runtime detail: {reason}",
  "localRuntime.modelLabel": "Local model",
  "localRuntime.modelHint": "Switching models restarts the runtime.",
  "localRuntime.reasoningLabel": "Reasoning effort",
  "localRuntime.reasoningHint": "Sets the thinking-token budget. Higher settings improve quality on hard tasks and increase response latency.",
  "localRuntime.reasoning.off": "Off",
  "localRuntime.reasoning.low": "Low",
  "localRuntime.reasoning.medium": "Medium",
  "localRuntime.reasoning.high": "High",
  "localRuntime.reasoning.xhigh": "Extra high",
  "agyUsage.titleMcp": "Antigravity MCP (AGY)",
  "agyUsage.refresh": "Refresh",
  "agyUsage.refreshHint": "Reads quota from the Antigravity CLI. Takes 20-40 seconds.",
  "agyUsage.reading": "Reading…",
  "agyUsage.never": "No reading yet. Use Refresh to fetch quota.",
  "agyUsage.stale": "Showing the last successful reading; the most recent refresh failed ({reason}).",
  "agyUsage.failed": "Could not read Antigravity quota: {reason}",
  "agyUsage.readFailed": "The Antigravity quota request failed.",
  "localRuntime.contextLabel": "Runtime context allocation (nCtx)",
  "localRuntime.contextInputLabel": "Runtime context allocation",
  "localRuntime.contextHint": "Allowed values are {min}–{max} in {step}-token steps. A change takes effect only after Apply & restart succeeds.",
  "localRuntime.contextCheckpoint": "{value}K",
  "localRuntime.contextChoicesHint": "Fixed choices: {choices}. A change takes effect only after Apply & restart succeeds.",
  "localRuntime.working": "Working…",
  "localRuntime.applyRestart": "Apply & restart",
  "localRuntime.resetDraft": "Reset",
  "localRuntime.stop": "Stop managed runtime",
  "localRuntime.start": "Start managed runtime",
  "localRuntime.requestCapTitle": "Provider request context cap",
  "localRuntime.requestCapHint": "The per-request model context cap is configured separately. It limits routed requests and must not exceed the effective runtime nCtx shown above.",
  "localRuntime.loadFailed": "Could not load the local runtime status.",
  "localRuntime.statusStale": "The last local runtime status remains visible, but it may be stale.",
  "localRuntime.staleRevision": "The runtime changed in another operation. Status was refreshed; review it before applying again.",
  "localRuntime.actionFailed": "The local runtime operation failed.",
  "localRuntime.restartAccepted": "The requested context was accepted. Runtime verification is in progress.",
  "localRuntime.actionAccepted": "The runtime operation was accepted.",
  "localRuntime.state.starting": "Starting and verifying",
  "localRuntime.state.running": "Running and verified",
  "localRuntime.state.restarting": "Restarting and verifying",
  "localRuntime.state.stopping": "Stopping",
  "localRuntime.state.rolledBack": "Rolled back to last known good",
  "localRuntime.state.failed": "Failed",
  "localRuntime.state.foreignPort": "Blocked: port is owned by another process",
  "localRuntime.state.stopped": "Stopped",
  "localRuntime.state.loading": "Loading…",
