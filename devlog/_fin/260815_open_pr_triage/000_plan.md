...
- Budget / bounds: wall-clock one session; BLOCKED if <private-ssh-host> or gh auth fails.
...
| wp6 | 030 | Final: <private-ssh-host> full suite on dev, verify all dispositions, report | wp2-wp5 |
...
- c3: full suite green on <private-ssh-host> against final dev head.
