...
branch `codex/bugfix-280` in worktree `<private-user-home>/Developer/opencodex-bugfix280`.

## Constraints

- The MAIN worktree (<private-user-home>/Developer/opencodex) hosts another active
