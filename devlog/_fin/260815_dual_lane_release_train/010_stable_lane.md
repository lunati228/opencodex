...
1. Use the dedicated release worktree `<private-user-home>/.codex/worktrees/rel-main`.
   ...
   without disturbing `<private-user-home>/Developer/new/700_projects/opencodex`
   (`dev`), `<private-user-home>/.codex/worktrees/260728-preview/opencodex`
