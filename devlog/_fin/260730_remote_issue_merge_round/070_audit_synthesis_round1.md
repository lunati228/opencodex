...
Fix: criterion 10 drives `LOCALAPPDATA: "   "` + `USERPROFILE: "<private-user-home>"` and asserts
`<private-user-home>\AppData\Local\Kiro-Cli\data.sqlite3`. All three rungs now have activation proof.
