...
2. Create clean sibling worktree `<private-user-home>/Developer/new/700_projects/opencodex-release-2.7.10` on `preview`; fast-forward it to `origin/dev` and publish the next unused preview prerelease.
