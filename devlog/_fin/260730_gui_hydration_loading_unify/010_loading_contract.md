...
붙는다([client-resource.ts:3](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/client-resource.ts:3),
[client-resource.ts:207](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/client-resource.ts:207)).
...
> `loading`을 올리지 않고([client-resource.ts:119](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/client-resource.ts:119)),
> 요청 시작 시점에 `emit`조차 하지 않는다. 폴링 틱도 인플라이트 중이면 건너뛴다
> ([client-resource.ts:99](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/client-resource.ts:99)).
...
([client-resource.ts:179](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/client-resource.ts:179)).
따라서 마운트 페치를 `setTimeout(..., 0)`로 늦추는 방식은 이 문서의 이관 대상에서 금지한다.
실제 0ms 타이머 구현은 cleanup에서 타이머를 취소하므로 마운트 직후 언마운트하면 요청 자체가
사라진다([ProviderWorkspaceShell.tsx:134](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/components/provider-workspace/ProviderWorkspaceShell.tsx:134)).
...
([use-dashboard-data.ts:232](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/pages/use-dashboard-data.ts:232)).
...
| `loading-with-stale-data` | 성공 데이터가 남아 있고 새 시도가 진행 중 | 기존 행·카드·값을 유지하고 해당 영역에 `aria-busy`와 작은 `DataSurfaceStatus`만 더한다. 기존 리소스도 데이터가 있을 때 조용한 poll에서 화면을 지우지 않는다([client-resource.ts:119](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/client-resource.ts:119)). |
...
([useCodexAccountPool.ts:109](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/hooks/useCodexAccountPool.ts:109),
[useCodexAccountPool.ts:148](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/hooks/useCodexAccountPool.ts:148)).
...
새 파일은 **`<private-user-home>/Developer/new/700_projects/opencodex/gui/src/data-surface.ts`**다.
...
([client-resource.ts:266](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/client-resource.ts:266)),
...
([client-resource.ts:292](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/client-resource.ts:292)).
성공 직후의 layout effect는 StrictMode에서 두 번 실행되어도 같은 두 값을 다시 쓰는 idempotent
연산이다. 앱 루트는 StrictMode를 켠 상태다([main.tsx:7](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/main.tsx:7)).
...
새 파일은 **`<private-user-home>/Developer/new/700_projects/opencodex/gui/src/components/data-surface.tsx`**다.
기존 `gui/src/ui.tsx`는 `Switch`, `Notice`, `Select`, `EmptyState`처럼 범용 조작 위젯을 모은
파일이다([ui.tsx:8](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/ui.tsx:8),
[ui.tsx:233](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/ui.tsx:233)). WP2의 컴포넌트는
데이터 상태 표현만 다루므로 `components/`에 별도 파일로 둔다.

**카드/row 프리미티브는 export하지 않는다.** `.setting-row`와 `.setting-label`의 실제 규칙은
이미 존재하고([styles.css:1831](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/styles.css:1831)),
...
([000_plan.md:35](<private-user-home>/Developer/new/700_projects/opencodex/devlog/_fin/260730_gui_hydration_loading_unify/000_plan.md:35),
[000_plan.md:38](<private-user-home>/Developer/new/700_projects/opencodex/devlog/_fin/260730_gui_hydration_loading_unify/000_plan.md:38)).
...
([styles.css:2030](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/styles.css:2030)),
...
이미 status role을 사용한다([ui.tsx:17](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/ui.tsx:17)).

## 4. CSS

수정 파일은 **`<private-user-home>/Developer/new/700_projects/opencodex/gui/src/styles.css`**다. `.spin`과
`@keyframes spin` 바로 뒤(현재 917–918행)에 아래 블록을 삽입한다. 기존
`codex-auth-skeleton-shimmer`는 1003행 계열에서 이미 사용되고
([styles.css:1009](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/styles.css:1009)), keyframes는
1279행에 이미 정의되어 있다([styles.css:1279](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/styles.css:1279)).
새 animation이나 token은 만들지 않는다. 간격·높이·색·radius는 기존 token만 쓴다
([styles.css:57](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/styles.css:57),
[styles.css:108](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/styles.css:108)).
...
([styles.css:920](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/styles.css:920)).
...
`common.loading`과 `common.retry`를 이미 가진다([en.ts:13](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/i18n/en.ts:13));
한국어에도 대응 key가 있다([ko.ts:13](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/i18n/ko.ts:13)).
현재 locale은 en, de, ko, zh, ru, ja 여섯 개다
([shared.ts:9](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/i18n/shared.ts:9)). 따라서 six-locale
추가 표도 없다.
...
([ko.ts:1](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/i18n/ko.ts:1),
[shared.ts:12](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/i18n/shared.ts:12)).
...
새 파일은 **`<private-user-home>/Developer/new/700_projects/opencodex/gui/tests/data-surface.test.tsx`**다.
happy-dom globals를 저장·복구하고 `act()` 안에서 mount/unmount하는 기존 GUI 테스트 형식을 따른다
([codex-account-pool-behaviour.test.tsx:30](<private-user-home>/Developer/new/700_projects/opencodex/gui/tests/codex-account-pool-behaviour.test.tsx:30),
[codex-account-pool-behaviour.test.tsx:97](<private-user-home>/Developer/new/700_projects/opencodex/gui/tests/codex-account-pool-behaviour.test.tsx:97)).
기존 resource 테스트도 `waitFor()`로 external-store 비동기 결과를 관찰한다
([client-resource-poll.test.tsx:29](<private-user-home>/Developer/new/700_projects/opencodex/gui/tests/client-resource-poll.test.tsx:29)).
...
않는다([000_plan.md:54](<private-user-home>/Developer/new/700_projects/opencodex/devlog/_fin/260730_gui_hydration_loading_unify/000_plan.md:54)).
...
- `setTimeout(() => void load(), 0)` 및 cleanup의 `clearTimeout`을 제거한다. mount 직후 구독이 request를 시작하는 것을 사용한다. 0ms 타이머가 있는 provider workspace 예시는 134–161행이다([ProviderWorkspaceShell.tsx:134](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/components/provider-workspace/ProviderWorkspaceShell.tsx:134)).
...
- `gui/src/hooks/useCodexAccountPool.ts` — `initialLoading`(첫 시도가 아직 미확정, 성공·실패
  ...
  상태도 올라가지 않는다([useCodexAccountPool.ts:140](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/hooks/useCodexAccountPool.ts:140)).
...
([codex-account-pool-main-card.tsx:212](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/components/codex-account-pool-main-card.tsx:212)).
...
기존 `Notice`도 `role="status"`이므로([ui.tsx:17](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/ui.tsx:17))
...
([client-resource.ts:38](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/client-resource.ts:38)).
...
([useCodexAccountPool.ts:134](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/hooks/useCodexAccountPool.ts:134)).
...
점진 페인트 설계다([useCodexAccountPool.ts:157](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/hooks/useCodexAccountPool.ts:157),
[useCodexAccountPool.ts:194](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/hooks/useCodexAccountPool.ts:194)).
...
([CodexAccountPool.tsx:189](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/components/CodexAccountPool.tsx:189)).
...
([codex-account-pool-controller.test.ts:16](<private-user-home>/Developer/new/700_projects/opencodex/gui/tests/codex-account-pool-controller.test.ts:16)).
...
([000_plan.md:36](<private-user-home>/Developer/new/700_projects/opencodex/devlog/_fin/260730_gui_hydration_loading_unify/000_plan.md:36)).
