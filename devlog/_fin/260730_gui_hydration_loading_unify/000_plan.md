...
2. **`client-resource.ts`를 버리지 않는다.** 실제 export는 `useClientResource`와
   ...
   [client-resource.ts:3](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/client-resource.ts:3).
...
원인이다 — [Providers.tsx:129](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/pages/Providers.tsx:129),
