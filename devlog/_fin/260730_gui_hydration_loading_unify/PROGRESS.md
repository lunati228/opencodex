...
# 로컬 트리로 링크
ln -s <private-user-home>/Developer/new/700_projects/opencodex \
...
([use-dashboard-data.ts](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/pages/use-dashboard-data.ts)),
...
([styles.css:1385](<private-user-home>/Developer/new/700_projects/opencodex/gui/src/styles.css:1385))
...
([parsing.ts:428](<private-user-home>/Developer/new/700_projects/opencodex/src/codex/catalog/parsing.ts:428)).
