...
[`tests/codex-v2-gate.test.ts`](<private-user-home>/Developer/new/700_projects/opencodex/tests/codex-v2-gate.test.ts).
...
- [`src/cli/v2.ts:86`](<private-user-home>/Developer/new/700_projects/opencodex/src/cli/v2.ts:86) — status display only.
- [`src/cli/v2.ts:100`](<private-user-home>/Developer/new/700_projects/opencodex/src/cli/v2.ts:100) — passes an explicit `threadLimit`, never translated.
- [`src/server/management/agent-settings-routes.ts:112`](<private-user-home>/Developer/new/700_projects/opencodex/src/server/management/agent-settings-routes.ts:112) and `:169` — `GET`/`PUT` response payload.
