...
in `<private-user-home>/developer/codex/121_openai-codex`. Every OpenCodex file:line cited was
read in `<private-user-home>/Developer/new/700_projects/opencodex` at branch `dev`, HEAD
`959e9ff11`.
