...
([src/codex/catalog/sync.ts:75](<private-user-home>/Developer/new/700_projects/opencodex/src/codex/catalog/sync.ts:75)):
...
`MAX_SPAWN_AGENT_MODEL_OVERRIDES = 5` ([sync.ts:43](<private-user-home>/Developer/new/700_projects/opencodex/src/codex/catalog/sync.ts:43))
