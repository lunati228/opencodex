...
## MODIFY — `<private-user-home>/Developer/new/700_projects/opencodex/src/usage/summary.ts`
...
## MODIFY — `<private-user-home>/Developer/new/700_projects/opencodex/tests/usage-summary.test.ts`
...
## MODIFY — `<private-user-home>/Developer/new/700_projects/opencodex/gui/src/components/provider-workspace/types.ts`
...
## MODIFY — `<private-user-home>/Developer/new/700_projects/opencodex/gui/src/provider-workspace/usage.ts`
...
## MODIFY — `<private-user-home>/Developer/new/700_projects/opencodex/tests/provider-workspace-data.test.ts`
...
## MODIFY — `<private-user-home>/Developer/new/700_projects/opencodex/gui/src/components/provider-workspace/ProviderWorkspaceShell.tsx`
...
## MODIFY — `<private-user-home>/Developer/new/700_projects/opencodex/gui/src/pages/Providers.tsx`
...
## MODIFY — `<private-user-home>/Developer/new/700_projects/opencodex/gui/src/components/provider-workspace/ProviderDetails.tsx`
...
## MODIFY — `<private-user-home>/Developer/new/700_projects/opencodex/gui/src/components/provider-workspace/ProviderUsage.tsx`
...
Run from `<private-user-home>/Developer/new/700_projects/opencodex` after implementation:
