...
All four pass, `bun run typecheck` clean, cursor suite green on `ssh <private-ssh-host>`,
...
Verified on `ssh <private-ssh-host>` at `c9681d0435`: typecheck clean, 630 pass / 0 fail.
