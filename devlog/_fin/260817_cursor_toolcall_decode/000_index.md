...
- Authoritative suite runs on `ssh <private-ssh-host>`, not the local workstation.
...
|-------|---------|----------|
| `010` clean-EOF terminal | **SHIPPED** `54f68daf5` | 7 audit rounds; red-before-green proven; <private-ssh-host> 608 pass/0 fail |
| `020` tool-result images | **SHIPPED** `878b067e8..cc906b0fc` | 5 review rounds; byte-equality with `4e167fd38` verified twice; <private-ssh-host> 624 pass/0 fail |
...
|-------|---------|----------|
| `010` clean-EOF terminal | **SHIPPED** `54f68daf5` | 7 rounds; <private-ssh-host> 608/0 |
| `020` tool-result images | **SHIPPED** `878b067e8..cc906b0fc` | 5 rounds; byte-equality verified twice; <private-ssh-host> 624/0 |
| `030` xai apply_patch | **NOT REPRODUCED** | live probe: both providers used `apply_patch` |
| `040` server-side cancel | **SHIPPED** `f145fd513..c9681d043` | <private-ssh-host> 630/0 |
| `050` terminal-less turns + #422 | **SHIPPED** `aa800ae65..1651002c5` | 8 rounds; <private-ssh-host> 12800/0 across 830 files |
