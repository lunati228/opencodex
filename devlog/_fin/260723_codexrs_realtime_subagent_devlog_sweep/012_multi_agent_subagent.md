...
- `<private-user-home>/Developer/codex/120_codex-cli/codex-rs/models-manager/models.json`
- `<private-user-home>/Developer/new/700_projects/opencodex/src/codex/data/upstream-models.json`
