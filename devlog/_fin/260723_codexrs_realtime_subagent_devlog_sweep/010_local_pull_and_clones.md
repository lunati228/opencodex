...
| --- | --- | --- | --- |
| `<private-user-home>/Developer/codex/120_codex-cli` | `https://github.com/openai/codex.git` | `main` tracking `origin/main` | `4462b9deef211723b781b426f5e5d36a5777115f` |
| `<private-user-home>/Developer/codex/120_codex-cli/codex-rs` | same repo nested path | same | same tip (monorepo path) |
| `<private-user-home>/Developer/codex/121_openai-codex` | `https://github.com/openai/codex.git` | feature `codex/spawn-agent-metadata-ux` | `fde7de4d0480695079e5aa79ef010ecf239f824a` |
