...
Executing worktree: `<private-user-home>/.codex/worktrees/8e2b/opencodex` (branch `codex/wt3-exec`, off dev@478354ee8). A spare prepared worktree also exists at `<private-user-home>/.codex/worktrees/260802-wt3-provider-wire`.
