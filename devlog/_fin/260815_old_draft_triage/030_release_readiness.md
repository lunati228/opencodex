...
- audit:high (root+gui): no vulnerabilities (also re-run in the <private-ssh-host> gate).
- Dependency/workflow hygiene: #1738 cleaned orphaned workflow identities.
- <private-ssh-host> full gates @ 9ed2e8459 (post-#1752 tree): 12347 tests, 0 fail.
- <private-ssh-host> full gates @ b5bf24fe7 (final tip incl. #1757): (pending at write time;
  see final report).
