...
`020` created `/tmp/ocx-cc-<sha>` on <private-ssh-host>, asserted its HEAD, and then listed the
...
`/tmp/ocx-L-` plus branch `ocx-L-` on <private-ssh-host>. Both removed; nothing was pushed or
