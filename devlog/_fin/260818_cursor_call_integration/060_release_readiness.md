...
`4f72d6f755` itself — not the pre-merge tip — in a dedicated <private-ssh-host> worktree pinned to
...
The platform gap that follows: <private-ssh-host> is Linux; CI covers Linux, Windows and macOS.
