...
`<private-ssh-host>/qwen3.8-27b-nvfp4` was registered through the supported CLI:

```
$ ocx models add <private-ssh-host> qwen3.8-27b-nvfp4 --context-window 262144 --modalities text,image
Error: custom model "<private-ssh-host>/qwen3.8-27b-nvfp4" already exists
```

The row was already present and complete in `~/.opencodex/config.json`:

```json
{ "id": "83ca0b4c-06bb-475d-b585-6c47b9d6be71", "provider": "<private-ssh-host>",
  "modelId": "qwen3.8-27b-nvfp4", "displayName": "Qwen3.8 27B NVFP4 (<private-ssh-host> 5090)",
...
```json
{ "slug": "<private-ssh-host>/qwen3.8-27b-nvfp4", "context_window": 262144,
...
```
candidateCapabilityEvidence(config, "<private-ssh-host>", "qwen3.8-27b-nvfp4")
...
<private-ssh-host>/qwen3.8-27b-nvfp4   => nothing                            (catalog only)
```
