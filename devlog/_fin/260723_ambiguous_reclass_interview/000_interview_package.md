...
2. Branch: use existing dev worktree `<private-user-home>/.codex/worktrees/f655/opencodex` (HEAD `dd8eda0f`, ahead origin/dev 3). Do **not** switch the main preview checkout.
