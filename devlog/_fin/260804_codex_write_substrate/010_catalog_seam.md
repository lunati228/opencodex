...
| config<private-user-home>/source/process-evidence refusal | `skipped/refused` |
...
catalog X, acquires K then C, completes generation<private-user-home>/process-local/target
