...
- providers: must have required properties providers
  File: <private-user-home>/.pi/agent/models.json
```
...
```
disable pi     2026-08-03T13:50:15Z  <private-user-home>/.pi/agent/models.json
disable gajae  2026-08-04T01:02:56Z  <private-user-home>/.gjc/agent/models.yml
```
