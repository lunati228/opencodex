...
1. Extend `<private-user-home>/Developer/new/700_projects/opencodex/src/adapters/kiro-events.ts`
   to parse terminal `{"usage": ...}` and `{"contextUsagePercentage": ...}` JSON frames.
2. Extend `<private-user-home>/Developer/new/700_projects/opencodex/src/adapters/kiro.ts`
...
4. Extend `<private-user-home>/Developer/new/700_projects/opencodex/src/types.ts` and
   `<private-user-home>/Developer/new/700_projects/opencodex/src/bridge.ts` with optional
