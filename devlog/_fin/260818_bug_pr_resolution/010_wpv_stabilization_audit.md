...
main..dev merge appropriateness audit + CI + <private-ssh-host> suite before continuing.

Range: origin/main (e97fb2621, v2.25.0) .. origin/dev (aaf04690e), 125 commits.
A new push to dev re-opens ALL THREE verifiers (CI, <private-ssh-host> suite, whole-delta diff).
...
- ssh <private-ssh-host> full suite (typecheck + bun test --isolate tests + privacy:scan) in a
...
- Failure baseline: any <private-ssh-host> failure is classified by bisect-attribution into
...
- <private-ssh-host> suite exit codes recorded; failures classified ours-vs-preexisting.
