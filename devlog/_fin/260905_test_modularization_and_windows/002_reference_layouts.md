...
- (a) `<home>/Developer/codex/120_codex-cli` (OpenAI Codex CLI; Rust workspace under `codex-rs/`)
- (b) `<home>/Developer/codex/160_hermes-agent` (Nous Hermes Agent; Python pytest suite)
- OpenCodex checkout: `<home>/.codex/worktrees/4b3a/opencodex` at `9c0e3ca80` (`codex/test-modularization-260905`)
...
Root: `<home>/Developer/codex/160_hermes-agent/tests/`. `AGENTS.md:308` still says "~17k tests across ~900 files as of May 2026"; live tree on 2026-09-05 is larger.
...
# Codex-rs
rg -l --glob '*.rs' '#\[cfg\(test\)\]' <home>/Developer/codex/120_codex-cli/codex-rs | wc -l
ls <home>/Developer/codex/120_codex-cli/codex-rs/core/tests/suite | wc -l
sed -n '268,370p' <home>/Developer/codex/120_codex-cli/.github/workflows/rust-ci-full-nextest-platform.yml

# Hermes
find <home>/Developer/codex/160_hermes-agent/tests -name 'test_*.py' | wc -l
sed -n '427,445p' <home>/Developer/codex/160_hermes-agent/pyproject.toml
sed -n '1,55p' <home>/Developer/codex/160_hermes-agent/.github/workflows/tests-os.yml
```
