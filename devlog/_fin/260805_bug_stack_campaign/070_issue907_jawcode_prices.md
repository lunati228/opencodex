...
- Local jawcode source `<private-user-home>/Developer/new/700_projects/jawcode/packages/ai/src/models.json`
...
`JAWCODE_MODELS_JSON=<private-user-home>/Developer/new/700_projects/jawcode/packages/ai/src/models.json bun run generate:jawcode-metadata`;
