...
them ran on macOS and on `ssh <private-ssh-host>`; the platform CI legs are the check that
actually matters.
...
```
full suite on ssh <private-ssh-host>      13,524 pass / 15 skip / 0 fail across 855 files
