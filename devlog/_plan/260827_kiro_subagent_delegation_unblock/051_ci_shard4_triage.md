...
All verification in this document was run on `ssh remote` at the user's
...
Run on `<private-user-home>/ocx-ci/opencodex` with the CI's own sharder,
...
```text
lidge-ai:<private-user-home>/ocx-ci/opencodex  (ad1627d38)
