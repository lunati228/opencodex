...
- Verifier: bun run typecheck + full bun run test on <private-ssh-host> (remote contract).
...
1. typecheck exit 0. 2. <private-ssh-host> full suite 0 fail (>= 13201 pass baseline).
