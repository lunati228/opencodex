...
```bash
cd <private-user-home>/Developer/opencodex
...
File: `<private-user-home>/Developer/opencodex/src/adapters/command-code.ts`
...
File: `<private-user-home>/Developer/opencodex/tests/app-owned-memory.test.ts`
