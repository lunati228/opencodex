...
Do not touch the dirty <private-user-home>/Developer/opencodex worktree beyond this unit and the goalplan.
Use an isolated remote-tip worktree, preferred path:

<private-user-home>/Developer/opencodex-chat-baseurl
