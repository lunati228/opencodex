...
- <private-user-home>/Developer/codex/120_codex-cli/codex-rs/core/src/tools/spec_plan.rs — is_hidden_by_code_mode_only, build_code_mode_executors
- <private-user-home>/Developer/codex/120_codex-cli/codex-rs/features/src/lib.rs — Feature::CodeModeOnly
- <private-user-home>/Developer/opencodex/src/codex/catalog/parsing.ts — applyRoutedCodexToolMode, normalizeRoutedCatalogEntry
- <private-user-home>/Developer/opencodex/docs-site/src/content/docs/guides/codex-integration.md — routed local tools section
- <private-user-home>/Developer/opencodex/structure/03_catalog-and-subagents.md — routed tool discovery section
...
1. Confirm branch: git -C <private-user-home>/Developer/opencodex rev-parse --abbrev-ref HEAD must print dev.
2. Confirm ancestry: git -C <private-user-home>/Developer/opencodex merge-base --is-ancestor origin/dev HEAD; echo $?
