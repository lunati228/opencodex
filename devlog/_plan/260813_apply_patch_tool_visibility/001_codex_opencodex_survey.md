...
- <private-user-home>/Developer/codex/120_codex-cli/codex-rs/features/src/lib.rs:99 — Restrict model-visible tools to code mode entrypoints (exec, wait).
- <private-user-home>/Developer/codex/120_codex-cli/codex-rs/core/src/tools/mod.rs:64-73 — effective_tool_mode() prefers model_info.tool_mode, else features.code_mode_only / features.code_mode.
- <private-user-home>/Developer/codex/120_codex-cli/codex-rs/core/src/tools/spec_plan.rs:256 and :431-441 — is_hidden_by_code_mode_only() drops nested-eligible tools from the outer list unless they are DirectModelOnly.
- <private-user-home>/Developer/codex/120_codex-cli/codex-rs/core/src/tools/spec_plan.rs:454-516 — build_code_mode_executors() re-exports those same specs inside exec.
- <private-user-home>/Developer/codex/120_codex-cli/codex-rs/code-mode-protocol/src/description.rs:12-35 and :248-269 — exec description advertises nested tools on tools / ALL_TOOLS; in code_mode_only it inlines the nested specs.
- <private-user-home>/Developer/codex/120_codex-cli/codex-rs/core/src/tools/handlers/apply_patch_spec.rs:9-26 — apply_patch remains a freeform custom tool.
- <private-user-home>/Developer/codex/120_codex-cli/codex-rs/tools/src/code_mode_tests.rs:92-114 — locks the nested shape declare const tools: { apply_patch(input: string): Promise<unknown>; };
- <private-user-home>/Developer/codex/120_codex-cli/codex-rs/core/src/tools/spec_plan_tests.rs:1032-1071 — code_mode_only_exposes_code_executor_and_hides_nested_tools.
...
- Codex: <private-user-home>/Developer/codex/120_codex-cli/codex-rs/models-manager/models.json
- OpenCodex snapshot: <private-user-home>/Developer/opencodex/src/codex/data/upstream-models.json
