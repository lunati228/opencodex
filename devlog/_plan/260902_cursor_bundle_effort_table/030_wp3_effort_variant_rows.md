...
- `@` is stripped by Cursor’s matcher and already appears in Codex account-selector values ([models-capabilities.ts](/Users/user/.codex/worktrees/4ed0/opencodex/src/server/models-capabilities.ts:45), [config.ts](/Users/user/.codex/worktrees/4ed0/opencodex/src/types/config.ts:681)).
- `:` is already a family separator in `modelRecordValue()` and is common in real model tags ([reasoning-effort.ts](/Users/user/.codex/worktrees/4ed0/opencodex/src/reasoning-effort.ts:115)).
- Single `-<effort>` collides with ordinary IDs such as `gpt-5.1-codex-max` and Cursor’s own effort suffixes.
- `--` has no routing/catalog semantics today. `routedSlug()` preserves hyphens while only encoding inner slashes ([slug-codec.ts](/Users/user/.codex/worktrees/4ed0/opencodex/src/providers/slug-codec.ts:24)).
...
[src/types/config.ts](/Users/user/.codex/worktrees/4ed0/opencodex/src/types/config.ts:366)
...
[src/config.ts](/Users/user/.codex/worktrees/4ed0/opencodex/src/config.ts:1046)
...
[src/server/index.ts](/Users/user/.codex/worktrees/4ed0/opencodex/src/server/index.ts:1511)
...
[src/server/responses/core.ts](/Users/user/.codex/worktrees/4ed0/opencodex/src/server/responses/core.ts:2750)
...
Writing both `parsed.options.reasoning` and `_rawBody.reasoning.effort` follows the existing dual-shape contract used by `applyEffortCap()` and `nativeEffortClamp()` ([effort-policy.ts](/Users/user/.codex/worktrees/4ed0/opencodex/src/server/effort-policy.ts:159), [core.ts](/Users/user/.codex/worktrees/4ed0/opencodex/src/server/responses/core.ts:2140)).

### 5. Chat Completions inbound

Modify [src/server/chat-completions.ts](/Users/user/.codex/worktrees/4ed0/opencodex/src/server/chat-completions.ts:89), not `chat-native.ts`.
...
This is necessary because [chat-native.ts](/Users/user/.codex/worktrees/4ed0/opencodex/src/server/chat-native.ts:120) sends directly and does not enter the Responses choke point where the existing cap/clamp runs. Ordinary Chat requests remain unchanged.
...
[src/server/claude-messages.ts](/Users/user/.codex/worktrees/4ed0/opencodex/src/server/claude-messages.ts:605)
...
[src/server/management/cursor-integration-routes.ts](/Users/user/.codex/worktrees/4ed0/opencodex/src/server/management/cursor-integration-routes.ts:23)
...
Mirror the fields in [gui/src/pages/integrations/cursor-api.ts](/Users/user/.codex/worktrees/4ed0/opencodex/gui/src/pages/integrations/cursor-api.ts:12). Rendering can remain a later lane; the status contract is sufficient for the GUI to distinguish native controls from variant rows.
