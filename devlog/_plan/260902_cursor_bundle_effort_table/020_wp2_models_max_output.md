...
- `modelCapabilityFields` currently emits `pricing.overrides` for long tiers but omits Cursor’s validated top-level `long_context_threshold_tokens` ([models-capabilities.ts](/Users/user/.codex/worktrees/4ed0/opencodex/src/server/models-capabilities.ts:97)).
- The generated tuple’s third column is `maxTokens`; `rowToMetadata` exposes it as `ModelMetadata.maxTokens`. It is the model output-token budget, not an input limit ([model-metadata.ts](/Users/user/.codex/worktrees/4ed0/opencodex/src/generated/model-metadata.ts:38), [generator](/Users/user/.codex/worktrees/4ed0/opencodex/scripts/generate-model-metadata.ts:90)).
- `CatalogModel` has `contextWindow`, `maxInputTokens`, and `inputModalities`, but no output-token field ([parsing.ts](/Users/user/.codex/worktrees/4ed0/opencodex/src/codex/catalog/parsing.ts:95)).
- Routed context/modalities arrive through provider configuration and live `/models` parsing; generated metadata also supplies them when jawcode rows are appended ([provider-fetch.ts](/Users/user/.codex/worktrees/4ed0/opencodex/src/codex/catalog/provider-fetch.ts:682), [provider-fetch.ts](/Users/user/.codex/worktrees/4ed0/opencodex/src/codex/catalog/provider-fetch.ts:1209), [provider-fetch.ts](/Users/user/.codex/worktrees/4ed0/opencodex/src/codex/catalog/provider-fetch.ts:2364)).
- `supports_reasoning` is already honest: it is `true` only when the advertised ladder is non-empty. Generated metadata’s boolean `reasoning` flag is not consulted, and should remain unused here ([models-capabilities.ts](/Users/user/.codex/worktrees/4ed0/opencodex/src/server/models-capabilities.ts:118)).

## Diff-level design

### 1. Extend the Cursor capability projection

[src/server/models-capabilities.ts](/Users/user/.codex/worktrees/4ed0/opencodex/src/server/models-capabilities.ts:57)
...
[src/codex/catalog/metadata.ts](/Users/user/.codex/worktrees/4ed0/opencodex/src/codex/catalog/metadata.ts:266)
...
Export it through [src/codex/catalog.ts](/Users/user/.codex/worktrees/4ed0/opencodex/src/codex/catalog.ts:5):
...
[src/codex/catalog/parsing.ts](/Users/user/.codex/worktrees/4ed0/opencodex/src/codex/catalog/parsing.ts:113)
...
[src/codex/catalog/provider-fetch.ts](/Users/user/.codex/worktrees/4ed0/opencodex/src/codex/catalog/provider-fetch.ts:566)
...
[src/codex/catalog/aggregation.ts](/Users/user/.codex/worktrees/4ed0/opencodex/src/codex/catalog/aggregation.ts:122)
...
[src/server/index.ts](/Users/user/.codex/worktrees/4ed0/opencodex/src/server/index.ts:1357)
