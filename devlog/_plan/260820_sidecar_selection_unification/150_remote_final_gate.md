# 150 — <private-ssh-host> final aggregate/release gate
...
- <private-ssh-host>: OCX_TEST_NO_QUEUE=1 bun run test — full suite green (baseline 13808+/0 at L9).
...
- Release staged on <private-ssh-host> per release-train conventions; promotion remains
