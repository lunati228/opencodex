...
- Post-merge reconciliations: capability-gated external_web_access (#2262,
  caught by the <private-ssh-host> lagging gate), raw-config capability declaration (#2263).
...
- <private-ssh-host> full suite at 6aecc8f15: see /tmp/ocx-gate-final.log (this doc's D attest).
