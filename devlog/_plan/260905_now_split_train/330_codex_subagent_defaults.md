...
ssh ci-host 'cd ~/ocx-ci/opencodex && git fetch origin codex/split-codex-subagent-defaults && git checkout -q FETCH_HEAD && bun install --frozen-lockfile && bun run test'
```
