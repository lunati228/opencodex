...
- Verifier: this document's authoritative Verification section; every layer must pass independently at its actual tip. All tests run on `ssh ci-host`, never locally.
