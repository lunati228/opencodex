...
ssh ci-host 'cd ~/ocx-ci/opencodex && git fetch origin codex/split-codex-cli-install-provenance && git checkout -q FETCH_HEAD && bun install --frozen-lockfile && bun run test'
```
