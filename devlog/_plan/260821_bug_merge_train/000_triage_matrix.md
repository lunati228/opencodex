...
- User authorized: stash/merge/cherry-pick/close/extra commits, push with --no-verify, suite on ssh <remote-ci-host> if needed, final CI green on dev is the exit gate.
