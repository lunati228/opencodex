...
outside that page returns `C:\Users\[user]\...` and the exact comparison rejected a
...
`C:\Users\[user]\.opencodex\service-launcher.vbs` — this process would then adopt, repair or
