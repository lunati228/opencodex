...
Research baseline: upstream checkout `<private-user-home>/Developer/codex/121_openai-codex`, branch `main`, HEAD `9dd22890f5ff47e4af128c20e32b9758a61d78d2` (2026-08-12). OPENCODEX baseline: `<private-user-home>/.codex/worktrees/e80c/opencodex`, detached worktree HEAD as inspected on 2026-08-16. Both repositories were read-only during research; this file is the only write.
