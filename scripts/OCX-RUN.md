...
On 2026-08-14 two `bun test` runs sat on a private remote host for **3h12m**. Both had stopped
...
ssh <remote-host> 'export PATH=$HOME/bin:$PATH
...
ssh <remote-host> 'export PATH=$HOME/bin:$PATH; ocx-run status'

ssh <remote-host> 'export PATH=$HOME/bin:$PATH; ocx-run tail suite 40'
ssh <remote-host> 'export PATH=$HOME/bin:$PATH; ocx-run stop suite'
```
