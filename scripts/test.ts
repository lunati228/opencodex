...
export function resolveBunTestArgs(
  ...
  // Bun's generic 5s default is below this repository's honest Windows CLI-spawn
  // latency under full-suite load. Keep a finite 30s default while allowing an
  // explicit caller timeout to remain authoritative.
  if (!hasCliFlag(effectiveRequested, "--timeout")) {
